...
def is_valid_record(record: dict):
    ...
    return record[S_EXP_NOTES] == "runtime_v1" and "environment_variables" not in record.keys()
...
if __name__ == '__main__':
    # d = get_benchmarks_data(benchmarks=["mobilenetv2", "resnet", "alexnet", "squeezenet"], return_as='df')
    d = get_benchmarks_data(benchmarks=["resnet"], return_as='df')
    print(d)
